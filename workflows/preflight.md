...
- **Outputs:** `ART-PREFLIGHT-001` scope draft; `ART-PREFLIGHT-003` context manifests; `ART-PREFLIGHT-004` workflow/gate plan; `ART-PREFLIGHT-005` Pre-flight Record with G0 status.
