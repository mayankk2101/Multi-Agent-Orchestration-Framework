...
4. Select the smallest applicable workflow and one owner per responsibility.
5. Stop at every required gate in [Review Gates](constitution/REVIEW_GATES.md).
6. Finish with the [Post-flight Workflow](workflows/postflight.md).
